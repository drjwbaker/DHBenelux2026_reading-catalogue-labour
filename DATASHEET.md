...
The published analysis: features and pairwise runs **20260313-120649**; similarity graph and Leiden communities run **20260417-152942** (5,585 in-graph records; 17,906 isolates; the *Dè a-nis?* community of 584). Figure 1 recomputes from the features file alone (`code/figure_shotlist_by_decade_v1.py`, verified against the published caption). Community detection is stochastic in tie-breaking; the community file is the published run.
